<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            <br />
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="input_disposisi">
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Surat Dari</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control" name="surat_dari">
                            <?php foreach ($data['raw_data'] as $row) {
                                if ($row['id_opd'] != '1') {
                                    echo '<option value="' . $row['id_opd'] . '">' . ucwords($row['nama_opd']) . '</option>';
                                }
                            } ?>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tanggal Surat</label>
                    ...
                    <fieldset>
                        <div class="control-group">
                            <div class="controls">
                                <div class="col-md-8 col-sm-6 col-xs-12 xdisplay_inputx form-group has-feedback">
                                    <input type="text" name="tgl_surat" class="form-control has-feedback-left" id="single_cal2" placeholder="Date" aria-describedby="inputSuccess2Status2">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tanggal Surat Masuk</label>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="col-md-8 xdisplay_inputx form-group has-feedback">
                                    <input type="text" name="tgl_masuk" class="form-control has-feedback-left" id="single_cal4" placeholder="Date" aria-describedby="inputSuccess2Status4">
                                    <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nomor Surat
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="no_surat" name="no_surat" class="form-control col-md-7 col-xs-12" placeholder="000/111/222/333 ">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"></label>
                    <small class="text-danger">Contoh : 000/111/222/333</small>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nomor Agenda
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="no_agenda" name="no_agenda" class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="perihal" name="perihal" class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Diteruskan Kepada
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="diteruskan" name="diteruskan" class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Isi
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="isi" name="isi" class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
